...
function SingleStory ({ user,conversationId }) {
  ...
  return (
    <>
    {viewStory &&  <ViewStoryModal handleClose={handleToggle} open={viewStory} conversationId={conversationId} data={user?.stories[0]} userData={user}/>}
